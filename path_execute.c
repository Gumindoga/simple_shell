...
/**
 * _path - Finds an executable in the system PATH
 * @args: command name
 * Return: Full path of the executable
 */
char *_path(char *args)
{
	char *path = _strdup(_get_environ("PATH"));
...
/**
 * _execute - Handles external commands
 * @data: Program data
